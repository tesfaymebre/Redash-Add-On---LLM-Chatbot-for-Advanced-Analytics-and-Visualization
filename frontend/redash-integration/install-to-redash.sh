...
echo ""
echo "Next steps (manual — see docs/architecture/task-03c-redash-integration.md):"
echo "  1. Patch QuerySource.jsx (import + sidebar in editor row)"
echo "  2. Add window.CHATBOT_BACKEND_URL in client/app/config/index.js"
echo "  3. Rebuild Redash client: cd $REDASH_ROOT && yarn build"
